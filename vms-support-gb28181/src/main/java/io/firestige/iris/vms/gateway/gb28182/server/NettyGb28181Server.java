...
public class NettyGb28181Server implements Gb28181Server {
    ...
    private final HttpServer sipServer;
    ...
    public NettyGb28181Server(HttpServer sipServer, ReactorSipHandlerAdapter handlerAdapter, Duration lifecycleTimeout,
                              Shutdown shutdown) {
    ...
    private DisposableServer startSipServer() {
        HttpServer server = this.sipServer;
